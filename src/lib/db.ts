...
const INITIAL_POSTS: Post[] = [
  ...
  { id: "about", title: "About June", subtitle: "사유하고 창작하는 삶에 대하여", content: "", createdAt: new Date("2026-06-01T09:00:00Z").toISOString(), type: "post" }
];
...
const getLocalPosts = (): Post[] => {
  ...
  try {
    ...
    const isNewAboutContent = hasAboutPost && parsed.find(p => p.id === "about")?.content === "";
